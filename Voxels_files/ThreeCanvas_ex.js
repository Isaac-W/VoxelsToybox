...
THREE.Face3 = function (e, d, h, g, f) {
    ...
    this.material = f instanceof Array ? f : [
    f
  ]
};
...
THREE.Face4 = function (f, e, j, i, h, g) {
    ...
    this.material = g instanceof Array ? g : [
    g
  ]
};
        ...
        var c = function (f) {
            ...
            function n(G, F, E, z, A, x, w) {
                var D = r.materials[z],
                    ...
                    u = b.normals[w * 3 + 1],
                    t = b.normals[w * 3 + 2];
                r.faces.push(new THREE.Face3(G, F, E, [
          new THREE.Vector3(J, I, H),
          new THREE.Vector3(C, B, y),
          new THREE.Vector3(v, u, t)
        ], D))
            }
            ...
            function k(L, K, J, H, I, C, B, A, y) {
                var D = r.materials[I],
                    ...
                    w = b.normals[y * 3 + 1],
                    u = b.normals[y * 3 + 2];
                r.faces.push(new THREE.Face4(L, K, J, H, [
          new THREE.Vector3(x, v, t),
          new THREE.Vector3(G, F, E),
          new THREE.Vector3(O, N, M),
          new THREE.Vector3(z, w, u)
        ], D))
            }
...
THREE.Particle = function (a) {
    ...
    this.material = a instanceof Array ? a : [
    a
  ];
